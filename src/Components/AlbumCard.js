...
function AlbumCard({i,title,id,setEditingAlbum,deleteAlbum}) {
  return (
    ...
    <Card.Body>
      ...
      <Button variant="secondary" style={{marginRight:'25px',marginTop:'30px'}} onClick={() => setEditingAlbum({ id, title })}>
        <FontAwesomeIcon  icon={faPenToSquare} />
      </Button>
      <Button  variant="secondary"style={{marginTop:'30px'}} onClick={() => deleteAlbum(id)}>
